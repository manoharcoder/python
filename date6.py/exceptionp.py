...
'''
# N=int(input("enter numerator::"))# N=int(input("enter numerator::"))
...
try:
    N=int(input("enter numerator::"))
    D=int(input("enter denominator::"))    # if it is 0 it gives a zero devision error
    print(N/D)     # to check zerodiviosion error
    mlist=[1,2,3,4,5]
    print(mlist)
    i=int(input("enter Index:"))
    print(mlist[i])   # to check index out of range error
    f=float(input("enter floating point::"))
    print("floating point number is ::",f)   # floating point error
    n=int(input("enter n::"))
    m=int(input("enter m::"))
    total=n+m                                 #invalid literal for int() with base 10: '"m"'
    print(total)    


except Exception as error:
    print("error occured and that type is ::",error)
finally:
    print("program ends")
